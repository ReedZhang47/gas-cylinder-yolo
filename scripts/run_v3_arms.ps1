...
# comparison (A/B) or re-trains the scale-curve point (gen493) under the v3 protocol.
#
...
#   -Arm gen493 : train = first generated batch, 394  -> runs\detect\gen493v3\<tag>
#                 (v3 re-run of the scale-curve point; the v1-era weights in
#                  runs\detect\gen493 are left untouched for comparison)
#
...
# test key of every yaml points at the independent v3 test set.
#
...
$runPrefix = @{ real93 = 'real93v3'; aug93 = 'aug93'; gen493 = 'gen493v3' }[$Arm]
