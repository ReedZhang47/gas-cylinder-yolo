...
- A/B/C 三臂与 L3 规模点（gen493 vs gen1085）的训练、三层评测、逐图缓存与配对聚类 bootstrap 全部完成。
- 三臂联合 OOF（主指标 mAP50-95）：C 0.6429 > A 0.4320 > B 0.3349；规模曲线 93 → 493 → 1085 为 0.4320 → 0.5019 → 0.6429。
- 主线实验部分到此完成；下一步为论文侧（主表、规模消融、选权稳定性）与可选稳健性消融，新增冻结 test 数据仍是最有价值的后续投入。执行板见 `NEXT_STEPS.md`。
